...
const Navbar = () => {
  ...
  return (
    <>
    <nav className='md:max-xl:px-0 navbar visible w-full fixed z-[999] px-16 py-5 flex align-center justify-between font-["Neue Montreal"] capitalize'>
      <div className='logo'>
      ...
      <div className='text1 link flex gap-10 font-md text-lg'>
        {["services", "Our Work", "About Us","Insights", "Contact us"].map((item, index)=>
        <a key={index} className={` ${index === 4 && "ml-56"}`}>{item}</a>
        )}
      </div>
    </nav>
    </>
