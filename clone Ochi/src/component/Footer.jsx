...
const Footer = () => {
  return (
    <div className="w-full h-screen flex">
      <div className="w-1/2 h-screen  flex flex-col justify-between p-10">
        <div className="  text-[8vw] font-bold leading-[8vw] tracking-tighter ">
          <h1>EYE-</h1>
          <h1>OPENING</h1>
        </div>
        <div>
      ...
      <div className="w-1/2 h-screen  font-normal  tracking-[-1vw]">
        <h1 className=" text-[8vw]">PRESENTATIONS</h1>
        <div className=" flex ">

       <div className="  w-1/2 h-[74vh] flex flex-col gap-[4rem]">
          
            <div className=" flex flex-col justify-center px-[1rem] tracking-tight">
              <h1 className="text-xl">S:</h1>
              {["Instagram", "Bahance", "Facebook", "Linkedin"].map(
                (item, index) => {
                  return (
                    <a
                      key={index}
                      className="w-[5vw] relative after:absolute after:w-[80px] after:left-0 after:bottom-0 after:h-[1px] after:bg-zinc-950"
                      href="#"
                    >
                      {item}
                    </a>
            ...
            <div className=" flex flex-col justify-center px-[1rem] tracking-tight">
              ...
              {[
                ...
                return (
                  <a
                    key={index}
                    className=" w-[10vw] socilamedia relative after:absolute after:w-[150px] after:left-0 after:bottom-0 after:h-[1px] after:bg-zinc-950"
                    href="#"
                  >
                    {item}
                  </a>
        ...
        <div className=" w-1/2 h-[74vh] flex items-center justify-end px-10">
        <div className=" flex flex-col justify-center px-[1rem] tracking-tight">
              ...
              {["Home", "Services", "Our work", "About us","Insights","Contact us"].map(
                (item, index) => {
                  return (
                    <a
                      key={index}
                      className="relative after:absolute after:w-[70px] after:left-0 after:bottom-0 after:h-[1px] after:bg-zinc-950"
                      href="#"
                    >
                      {item}
                    </a>
